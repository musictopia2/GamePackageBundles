...
namespace MiscSpecializedCardGames.Droid
{
    [Activity(Label = "MiscSpecializedCardGames", Icon = "@mipmap/icon", Theme = "@style/MainTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
