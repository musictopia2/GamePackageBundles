...
public class BasicViewModel(IStartUp starts) : LoaderViewModel(starts)
{
    ...
    protected override Type GetGameType()
    {
        ...
        if (GameName == "Clue Card Game")
        {
            return typeof(ClueCardGame.Blazor.Index);
        }
        ...
        if (GameName == "Sorry Diced Game")
        {
            return typeof(SorryDicedGame.Blazor.Index);
        }
        if (GameName == "Spades")
        {
    ...
    protected override IGameBootstrapper ChooseGame()
    {
        ...
        if (GameName == "Clue Card Game")
        {
            return new ClueCardGame.Blazor.Bootstrapper(Starts, Mode);
        }
        if (GameName == "Concentration")
        {
        ...
        if (GameName == "Sorry Diced Game")
        {
            return new SorryDicedGame.Blazor.Bootstrapper(Starts, Mode);
        }
        if (GameName == "Spades")
        {
