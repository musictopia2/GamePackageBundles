...
namespace AndyFavoriteSoloGames.Droid
{
    [Activity(Label = "AndyFavoriteSoloGames", Icon = "@mipmap/icon", Theme = "@style/MainTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
