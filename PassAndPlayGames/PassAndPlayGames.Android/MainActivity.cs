...
namespace PassAndPlayGames.Droid
{
    [Activity(Label = "PassAndPlayGames", Icon = "@mipmap/icon", Theme = "@style/MainTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
